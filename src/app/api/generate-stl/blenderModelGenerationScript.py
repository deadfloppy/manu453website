...
if not os.path.exists(f"/mnt/volume-nov"):
    ...
    csv_file = f"/mnt/volume-nov/tmp/{jobId}/{jobId}.csv"  
print(csv_file)
delimiter = ","
skip_header = True
...
if not os.path.exists(f"/mnt/volume-nov"):
    ...
    base_path = f"/mnt/volume-nov/tmp/{jobId}"
...
if not os.path.exists(f"/mnt/volume-nov"):
    bpy.ops.wm.stl_export(filepath=f'{base_path}/{jobId}.stl', check_existing=True)
else:
    bpy.ops.export_mesh.stl(filepath=f'{base_path}/{jobId}.stl', check_existing=True)
